...
const Workshop = () => {
    return (
        <main className='md:mt-8 md:ml-48 lg:ml-52 xl:ml-60 font-main'>
            <h1 className='text-2xl md:text-3xl pl-5 mb-2'>{workshops[0].title}</h1>
            <h3 className='text-xl md:text-2xl pl-6 mb-8 md:mb-1'>{workshops[0].organisation}</h3>
            <p className='w-4/5 mx-auto font-light md:text-lg lg:w-3/5'>{workshops[0].description}</p>
